...
// 最直观的方法，没有利用到数组是递增的这一条件
bool FindNumbersWithSum1(int data[], int length, int sum, int* num1, int* num2)
{
    bool found = false;
...
void Test(const char* testName, int data[], int length, int sum, bool expectedReturn)
{
    ...
    int num11, num22;
    int result1 = FindNumbersWithSum1(data, length, sum, &num11, &num22);
